...
// const getNextBlogIndex = (index) =>
//   index === blogs.length - 1 ? 0 : index + 1;

// const currentBlog = blogs[currentBlogIndex];
// const nextBlog = blogs[getNextBlogIndex(currentBlogIndex)];
...
// const nextNextTech = getTechAtIndex(currentTechIndex + 2);
// const nextNextNextTech = getTechAtIndex(currentTechIndex + 3);
...
{/* <div className="experience-section">
  <div className="experience-content">
    ...
    <div className="left-content">
      ...
      <h2>Ensuring Your Success Trusted IT Services Source</h2>
      <p>
      We provide comprehensive IT support to ensure your business runs smoothly with minimal downtime. From managing network infrastructures to offering security solutions, our proactive approach helps prevent issues before they arise, ensuring your technology works seamlessly for you. Our dedicated team is always on hand to provide expert guidance, allowing you to focus on growing your business. Whether it's troubleshooting, system upgrades, or IT consultation, we've got you covered every step of the way.
      </p>
    ...
    <div className="experience-features">
      <ul>
        ...
        <li> Expert & Dedicated Team Members</li>
        <li>24/7 Free Technical Support</li>
        <li> 100% Customer Satisfaction</li>
        <li>Comprehensive IT Consultation</li>
        <li>Rapid Response to Critical Issues</li>
        <li> Customized IT Strategies</li>
      </ul>
    </div>
...
{/* <div className="solution-section">
  <h2>How We Solve the IT Problems</h2>
  ...
  <div className="solution-container">
    <div className="solution-card">
      ...
      <p>
        We enhance your network infrastructure to ensure faster and more reliable connectivity, minimizing disruptions and increasing operational efficiency.
      </p>
    </div>
    ...
    <div className="solution-card">
      ...
      <p>
        Our top-notch security systems shield your business from cyber threats, ensuring your data remains safe from unauthorized access and breaches.
      </p>
    </div>
    ...
    <div className="solution-card">
      ...
      <p>
        We help you transition to cloud-based solutions, providing scalability and reducing the need for on-premise hardware, saving costs in the long run.
      </p>
    </div>
    ...
    <div className="solution-card">
      ...
      <p>
        Our team ensures your servers are running smoothly with regular maintenance, preventing downtime and avoiding costly disruptions.
      </p>
    </div>
    ...
    <div className="solution-card">
      ...
      <p>
        We provide round-the-clock support to quickly resolve any IT issues, so your business can keep operating without unexpected halts.
      </p>
    </div>
    ...
    <div className="solution-card">
      ...
      <p>
        Our team integrates the latest software solutions to streamline your operations, allowing you to leverage cutting-edge tools for maximum productivity.
      </p>
    </div>
  </div>
</div> */}
   ...
   {/* <div id="expertise-section">
      ...
      <div className="services-container">
        ...
        <div className="service-card">
          <div className={`service-card-inner ${flippedCards[0] ? 'flipped' : ''}`}>
     
            <div
              className="service-card-front"
              style={{
                backgroundImage:
                  'url(https://media.istockphoto.com/id/2114295998/photo/asian-and-indian-developer-devops-team-discussion-about-coding-promgram-with-software.webp?a=1&b=1&s=612x612&w=0&k=20&c=qNgHSOfUKy-jPjzg9JmtQ0_fuKw2TvGC02gRSsJpGEc=)',
              }}
            >
              <div className="service-info">
                <h3>Software Development</h3>
                <p>Delivering tailored software solutions that meet your business requirements.</p>
                <button onClick={(e) => handleReadMore(e, 0)}>Read More</button>
              </div>
            </div>
            ...
            <div className="service-card-back">
                ...
                <p>
                  Transform your ideas into robust software solutions with our expert development team. Achieve
                  business agility and efficiency with custom applications tailored to your needs.Transform your ideas into robust software solutions with our expert development team. Achieve
                  business agility and efficiency with custom applications tailored to your needs.Transform your ideas into robust software solutions with our expert development team. Achieve
                  business agility and efficiency with custom applications tailored to your needs.
                </p>
                <button className='goBack_btn' onClick={(e) => handleGoBack(e, 1)}>Go Back</button>
        ...
        <div className="service-card">
          <div className={`service-card-inner ${flippedCards[1] ? 'flipped' : ''}`}>
            <div
              className="service-card-front"
              style={{
                backgroundImage:
                  'url(https://images.unsplash.com/photo-1448932223592-d1fc686e76ea?q=80&w=2069&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)',
              }}
            >
              <div className="service-info">
                <h3>UI & UX Design</h3>
                <p>Design cutting-edge user interfaces and experiences that stand out from the rest.</p>
                <button onClick={(e) => handleReadMore(e, 1)}>Read More</button>
              </div>
            </div>
            <div className="service-card-back">
              <div className="back-info">
                <p>
                  Enhance user satisfaction with our intuitive UI & UX design services. We create visually appealing and user-friendly interfaces that ensure a seamless experience across all devices.Enhance user satisfaction with our intuitive UI & UX design services. We create visually appealing and user-friendly interfaces that ensure a seamless experience across all devices.Enhance user satisfaction with our intuitive UI & UX design services. We create visually appealing and user-friendly interfaces that ensure a seamless experience across all devices.
                </p>
                <button onClick={(e) => handleGoBack(e, 1)}>Go Back</button>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="service-card">
          <div className={`service-card-inner ${flippedCards[2] ? 'flipped' : ''}`}>
            <div
              className="service-card-front"
              style={{
                backgroundImage:
            ...
            >
              <div className="service-info">
                ...
                <button onClick={(e) => handleReadMore(e, 2)}>Read More</button>
              </div>
            </div>
            <div className="service-card-back">
              <div className="back-info">
                <p>
                  Transform your online presence with our comprehensive web development services. We build responsive, scalable, and high-performing websites tailored to your business needs.Transform your online presence with our comprehensive web development services. We build responsive, scalable, and high-performing websites tailored to your business needs.Transform your online presence with our comprehensive web development services. We build responsive, scalable, and high-performing websites tailored to your business needs.
                </p>
                <button onClick={(e) => handleGoBack(e, 2)}>Go Back</button>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="service-card">
          <div className={`service-card-inner ${flippedCards[3] ? 'flipped' : ''}`}>
            <div
              className="service-card-front"
              style={{
                backgroundImage:
                  'url(https://media.istockphoto.com/id/1187869343/photo/developing-mobile-application.webp?a=1&b=1&s=612x612&w=0&k=20&c=utbiHpcR_0OC8ypMYi4SgjXC5Lb5ofPg5AjdwWA14yk=)',
              }}
            >
              <div className="service-info">
                <h3>Mobile Development</h3>
                <p>Creating versatile applications for various platforms.</p>
                <button onClick={(e) => handleReadMore(e, 3)}>Read More</button>
              </div>
            </div>
            <div className="service-card-back">
              <div className="back-info">
                <p>
                  Reach your audience on the go with our mobile development services. We create user-friendly, feature-rich mobile applications for both iOS and Android platforms, ensuring a seamless user experience.Reach your audience on the go with our mobile development services. We create user-friendly, feature-rich mobile applications for both iOS and Android platforms, ensuring a seamless user experience.Reach your audience on the go with our mobile development services. We create user-friendly, feature-rich mobile applications for both iOS and Android platforms, ensuring a seamless user experience.
                </p>
                <button onClick={(e) => handleGoBack(e, 3)}>Go Back</button>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="service-card">
          <div className={`service-card-inner ${flippedCards[4] ? 'flipped' : ''}`}>
            <div
              className="service-card-front"
              style={{
                backgroundImage:
                  'url(https://media.istockphoto.com/id/1552848391/photo/laptop-phone-and-hologram-of-woman-for-data-protection-safety-software-development-or.webp?a=1&b=1&s=612x612&w=0&k=20&c=SK_DBlYmFGx2H-kTFAhOfsg9mbjFWPH2cWKjhZUWaEg=)',
              }}
            >
              <div className="service-info">
                <h3>Cyber Security</h3>
                <p>Protecting your business data from threats and breaches.</p>
                <button onClick={(e) => handleReadMore(e, 4)}>Read More</button>
              </div>
            </div>
            <div className="service-card-back">
              <div className="back-info">
                <p>
                  Protect your digital assets with our comprehensive cyber security solutions. We offer proactive measures to safeguard your business against threats, ensuring data integrity and confidentiality.Protect your digital assets with our comprehensive cyber security solutions. We offer proactive measures to safeguard your business against threats, ensuring data integrity and confidentiality.Protect your digital assets with our comprehensive cyber security solutions. We offer proactive measures to safeguard your business against threats, ensuring data integrity and confidentiality.
                </p>
                <button onClick={(e) => handleGoBack(e, 4)}>Go Back</button>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="service-card">
          <div className={`service-card-inner ${flippedCards[5] ? 'flipped' : ''}`}>
            <div
              className="service-card-front"
              style={{
                backgroundImage:
                  'url(https://media.istockphoto.com/id/943067460/photo/male-it-specialist-holds-laptop-and-discusses-work-with-female-server-technician-theyre.webp?a=1&b=1&s=612x612&w=0&k=20&c=fEdvivPI1wHmbQvnDl6WZcVbzS8lmlcf7pNJq9DWklM=)',
              }}
            >
              <div className="service-info">
                <h3>Cloud Computing</h3>
                <p>Enhancing scalability and efficiency with cloud-based solutions.</p>
                <button onClick={(e) => handleReadMore(e, 5)}>Read More</button>
              </div>
            </div>
            <div className="service-card-back">
              <div className="back-info">
                <p>
                  Leverage the power of cloud computing to enhance flexibility and scalability in your operations. Our cloud solutions enable seamless data access and collaboration, empowering your team to work from anywhere.Leverage the power of cloud computing to enhance flexibility and scalability in your operations. Our cloud solutions enable seamless data access and collaboration, empowering your team to work from anywhere.
                </p>
                <button onClick={(e) => handleGoBack(e, 5)}>Go Back</button>
              </div>
            </div>
          </div>
        </div>
...
<div className="carousel-container">
  ...
  <div className="carousel-content">
    ...
    <div className="carousel-slides">
      ...
      {/* <div className="carousel-slide">
        <img src={nextNextTech.icon} alt={nextNextTech.name} />
        <p>{nextNextTech.name}</p>
      </div> */}

      {/* <div className="carousel-slide">
        <img src={nextNextNextTech.icon} alt={nextNextNextTech.name} />
        <p>{nextNextNextTech.name}</p>
      </div> */}
    </div>
