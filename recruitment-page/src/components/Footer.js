...
import './Footer.css';
import logo from '../components/LogoCandiclie.png';
    ...
    <footer className={`footer page-content ${theme}`}>
      ...
      <div className="footer-container">
        ...
        <div className="footer-left">
          ...
          <a href="/">
        <img src={Link} alt="Instagram" className="icon-image" />
         </a>
        ...
        <img src={Insta} alt="Instagram" className="icon-image" />
         ...
         <a href="/">
        <img src={Face} alt="Instagram" className="icon-image" />
         </a>

         <a href="/">
        <img src={Twit} alt="Instagram" className="icon-image" />
         </a>
          </div>
        </div>
      </div>
